...
python experiment.py "48" "LLAMA Calculator long" #"Lightweight pipeline test trick" # "LLAMA Calculator trick 2"  # "Big LLAMA pipeline test"   "Lightweight pipeline test trick" #"LLAMA Calculator trick"
/usr/bin/nvidia-smi
uptime
duration=$SECONDS
echo $(date)
